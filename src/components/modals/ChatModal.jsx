...
const ChatModal = ({
  ...
  // Scroll to bottom when messages change - FIXED with requestAnimationFrame
  useEffect(() => {
    ...
    const handleReceiveMessages = (response) => {
      ...
      if (response?.status === 200) {
        ...
        const formattedMessages = (
          ...
          const isAdminMessage = String(msgSenderId) === String(adminId);
      ...
      setMessages((prev) => {
        ...
        return [
          ...prev,
          {
            _id: msgId,
            role:
              !msgSenderId || String(adminId) === String(msgSenderId)
                ? "admin"
                : "user",
            text: msg.message || "",
            time: msg.createdAt,
